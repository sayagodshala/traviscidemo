...
public class ArcViewOne extends View{
    ...
    private final int default_finished_color = getResources().getColor(R.color.progress_refferal);
    ...
    public ArcViewOne(Context context) {
        this(context, null);
    }

    public ArcViewOne(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ArcViewOne(Context context, AttributeSet attrs, int defStyleAttr) {
