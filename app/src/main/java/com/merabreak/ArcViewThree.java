...
/**
 * Created by ETPL-002 on 08-Dec-17.
 */

public class ArcViewThree extends View{
    ...
    private final int default_finished_color = getResources().getColor(R.color.progress_raffles);
    private final int default_unfinished_color = getResources().getColor(R.color.progress_empty);
    private final int default_text_color = getResources().getColor(R.color.progress_number);
    ...
    public ArcViewThree(Context context) {
        this(context, null);
    }

    public ArcViewThree(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ArcViewThree(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        default_stroke_width = Util.dp2px(getResources(), 6);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        /*if (!TextUtils.isEmpty(getBottomText())) {
            ...
            Typeface font = Typeface.createFromAsset(getContext().getAssets(), "fonts/roboto_medium.ttf");
