...
public class ArcViewTwo extends View{
    ...
    private final int default_finished_color = getResources().getColor(R.color.progress_points);
    ...
    public ArcViewTwo(Context context) {
        this(context, null);
    }

    public ArcViewTwo(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ArcViewTwo(Context context, AttributeSet attrs, int defStyleAttr) {
