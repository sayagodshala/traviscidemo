...
public class OneTimeChallengeTCActivity extends BaseActivity implements MeraBreakWebViewClient.MeraBreakWebViewClientListener {
    ...
    void init() {
        ...
        new MeraBreakWebViewClient(webView, Constants.TERMS_PRIVACY_BASE_URL + "/singlechallengetermsandconditions_app.html", this);
    }
