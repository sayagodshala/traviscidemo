...
public class JigsawPuzzle {
     ...
     *
     * @param res
     * @param resourceId This jigsaw puzzle will be configured dynamically by partitioning
    ...
    public void loadPuzzleResources(Resources res, int resourceId, long targetWidth, long targetHeight) {
        ...
        backgroundTexture = decodePuzzleBitmapFromResource(res, R.drawable.back_pattern, 800, 800);
