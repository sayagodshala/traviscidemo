...
/**
 * Created by sayagodshala on 04/02/16.
 */
public class JigsawPuzzleConfiguration {
    ...
    public static Bundle getKittenExample() {
        ...
        image.putInt("img_id", R.drawable.dummy_challenge_image);
    ...
    public static Bundle getRcatKittenExample() {
        ...
        img.putInt("img_local", R.drawable.dummy_challenge_image);
    ...
    private JigsawPuzzleConfiguration() {
