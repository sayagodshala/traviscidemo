...
public class SlidePuzzle {
    ...
    public void init(int width, int height, int column, int rows) {
        this.width = column;
        this.height = rows;
        tiles = new int[column * rows];
        //Log.d("Tiles", tiles.length + "");
    ...
    public void shuffle() {
        ...
        while (distance() < limit) {
            ...
            //Log.d("@@@@@@@@@@@@@@@@1", "move = " + move + "distance()" + distance());
            moveTile(move, 1);
        }
